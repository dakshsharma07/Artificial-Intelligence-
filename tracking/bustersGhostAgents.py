# bustersGhostAgents.py͏󠄂͏️͏󠄌͏󠄎͏󠄎͏︇͏󠄌
# ---------------------͏󠄂͏️͏󠄌͏󠄎͏󠄎͏︇͏󠄌
...
class DispersingGhost( ghostAgents.GhostAgent ):
    ...
    def getDistribution( self, state ):
        ...
        # get other ghost positions͏󠄂͏️͏󠄌͏󠄎͏󠄎͏︇͏󠄌
        ...
        # for each action, get the sum of inverse squared distances to the other ghosts͏󠄂͏️͏󠄌͏󠄎͏󠄎͏︇͏󠄌
        sumOfDistances = []
